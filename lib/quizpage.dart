...
class _QuizPageState extends State<QuizPage> {
  ...
  //var random = (getQuestions()..shuffle()).first;
  Color color;
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              new FlatButton(
                  ...
                  child: Text("Sair", style: TextStyle(fontSize: 15.0))),
              new FlatButton(
                  onPressed: () {
                    Navigator.of(context).pop();
                    Navigator.pushReplacement(
                  ...
                  child: Text("Pontuação", style: TextStyle(fontSize: 15.0))),
            ],
            shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.all(Radius.circular(20.0))),
          );
                  ...
                  Expanded(
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(Icons.help, size: 50.0, color: Colors.white),
                      ),
                    ),
                  )),
                  Divider(),
